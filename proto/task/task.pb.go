...
const file_task_task_proto_rawDesc = "" +
	"\n" +
	"\x0ftask/task.proto\x12\x04task\"\\\n" +
	"\x04Task\x12\x0e\n" +
	...
	"\n" +
	"DeleteTask\x12\x17.task.DeleteTaskRequest\x1a\x18.task.DeleteTaskResponseB0Z.github.com/Wendiboy/project-protos/proto/tasksb\x06proto3"
...
var file_task_task_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
